...
CLNT_MAX_BATCH_SIZE=100   #default 100
CLNT_GRV_BATCH_TIMEOUT=0.005 #default 0.005
CLNT_KNOBS="--additional_args max_batch_size=${CLNT_MAX_BATCH_SIZE},grv_batch_timeout=${CLNT_GRV_BATCH_TIMEOUT}"
